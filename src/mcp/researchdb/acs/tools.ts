...
export const researchAcsSearchInput = objectSchema<AcsSearchArgs>({
  ...
  profile: { ...scalar.string("Managed browser profile"), default: "nuaa-acs" },
...
export const acsResearchTools = [
  { name: "research_acs_search", description: "Search ACS Publications via the verified NUAA ACS headless recipe.", schema: researchAcsSearchInput, handler: async (args: AcsSearchArgs) => researchAcsSearch(args) },
