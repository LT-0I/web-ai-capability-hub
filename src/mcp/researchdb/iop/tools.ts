...
export const researchIopSearchInput = objectSchema<IopSearchArgs>({
  ...
  profile: { ...scalar.string("Managed browser profile"), default: "nuaa-iop" },
...
export const iopResearchTools = [
  { name: "research_iop_search", description: "Search IOPscience via the verified NUAA IOPscience /nsearch URL-parameter recipe.", schema: researchIopSearchInput, handler: async (args: IopSearchArgs) => researchIopSearch(args) },
