...
- Finished: 2026-05-26T09:15:52.209Z
- Result: 1/8 PASS
- Ship gate: STOP
...
| F | claude-generate-file-pptx-ext | FAIL | 0 | command gate failed: exit_code 1 !== 0; json_path path empty |
| C#14 | gemini-send-web-search-mgr | FAIL | 0 | command gate failed: exit_code 1 !== 0; json_path response_text regex /20\d{2}/ failed |
| C#16 | gemini-veo-quota-error-mgr | FAIL | 0 | command timed out |
