...
generated .pdf file lives ephemerally at /mnt/data/ in the sandbox and
there is no end-user click to retrieve it.

A separate empirical attempt for pdf is omitted (one-attempt budget, no
retries). True pdf download requires either:
...
.pdf download surface for assistant-generated artifacts.
