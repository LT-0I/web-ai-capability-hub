...
generated .docx file lives ephemerally at /mnt/data/ in the sandbox and
there is no end-user click to retrieve it.

A separate empirical attempt for docx is omitted (one-attempt budget, no
retries). True docx download requires either:
...
.docx download surface for assistant-generated artifacts.
