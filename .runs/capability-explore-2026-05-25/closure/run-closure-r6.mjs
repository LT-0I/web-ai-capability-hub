...
const RUN_ROOT = path.join(ROOT, '.runs/capability-explore-2026-05-25/closure-r6');
const RESULTS_JSONL = path.join(RUN_ROOT, 'closure-results.jsonl');
const REPORT_PATH = path.join(ROOT, '.runs/capability-explore-2026-05-25/closure-r6-report.md');
