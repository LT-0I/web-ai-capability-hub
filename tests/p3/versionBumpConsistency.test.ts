...
test("p3: consumer-contract.json contract_version is consumer-contract-1.10.0 after Chrome Extension Phase 4", () => {
...
test("p3: scripts/verify-contract-version.ts EXPECTED_CONTRACT_VERSION === 'consumer-contract-1.10.0'", () => {
  assert.match(VERIFY, /EXPECTED_CONTRACT_VERSION\s*=\s*"consumer-contract-1\.10\.0"/);
});
