...
const newSnap = read('tests/golden/listMcpTools.193.json');
...
const expected = ['wah_adapter_health','wah_artifact_get','wah_capability_query','wah_policy_explain','wah_task_cancel','wah_task_resume','wah_task_start','wah_task_status'].sort();
